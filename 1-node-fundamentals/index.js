...
function readWriteSync() {
  ...
  dataSync = readFileSync("./input/input.txt");
  writeFileSync("./output/output.txt", dataSync);
  console.log(
...
function readSyncWriteAsync() {
  ...
  dataSync = readFileSync("./input/input2.txt");
  writeFileAsync("./output/output2.txt", dataAsync);
  console.log(
...
function readWriteAsync() {
  ...
  readFileAysncPromiseWrapped("./input/input2.txt")
    .then((dataAsync) => {
      writeFileAsync("./output/output2.txt", dataAsync);
    })
    .catch((err) => {
...
function readAsyncWriteSync() {
  ...
  readFileAysncPromiseWrapped("./input/input.txt")
    .then((dataAsync) => {
      writeFileSync("./output/output.txt", dataAsync);
    })
    .catch((err) => {
      console.log("Failed while reading async");
    });
